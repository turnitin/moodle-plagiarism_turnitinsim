...
class submission_class_testcase extends advanced_testcase {
    ...
    public function test_update() {
        ...
        $this->assertIsInt($tssubmission->getid());
    ...
    public function test_create_owners_metadata_returns_all_group_member_details_as_owners() {
        ...
        // Check user array returns correct details.
        $this->assertStringContainsString( $this->student1->lastname, $owners[0]['family_name']);
        $this->assertStringContainsString( $this->student1->firstname, $owners[0]['given_name']);
        $this->assertStringContainsString( $this->student1->email, $owners[0]['email']);
        $this->assertStringContainsString( $tsuser1->get_turnitinid(), $owners[0]['id']);

        $this->assertStringContainsString( $this->student2->lastname, $owners[1]['family_name']);
        $this->assertStringContainsString( $this->student2->firstname, $owners[1]['given_name']);
        $this->assertStringContainsString( $this->student2->email, $owners[1]['email']);
        $this->assertStringContainsString( $tsuser2->get_turnitinid(), $owners[1]['id']);
    }
